<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link {{Request:: is('admin/category/create')?'active bg-gradient-dark text-white': 'text-dark'}}" href="{{route('admin.category.table')}}">
            <i class="material-symbols-rounded opacity-5">receipt_long</i>
            <span class="nav-link-text ms-1">Categories</span>
          </a>
        </li>
        <li class="nav-item">
           <a class="nav-link {{Request:: is('admin/brand/create')?'active bg-gradient-dark text-white': 'text-dark'}}" href="{{route('admin.brand.table')}}">
